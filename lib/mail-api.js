...
class MoEmailClient {
  ...
  async fetchDomains() {
    ...
    const rawDomainList = data?.domains
      || data?.data?.domains
      || data?.data?.domainList
      || data?.data?.mailDomains
      || data?.data?.emailDomains
      || data?.config?.emailDomains
      || data?.config?.domains
      || data?.mailDomains
      || data?.emailDomains
      || data?.domainList
    ...
    const domainList = (Array.isArray(rawDomainList) ? rawDomainList : [])
      .map((item) => {
